                  ...
                  <section class="sidebar">
                    ...
                    <!-- sidebar menu: : style can be found in sidebar.less -->
                      ...
                      <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview">
                            <a href="#">
                              <i class="fa fa-dashboard"></i> <span>Product Control</span>
                              <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                              </span>
                            </a>
                            <ul class="treeview-menu">
                              <li class="active"><a href="/adminpanel/products/create"><i class="fa fa-circle-o"></i>Add New Product</a></li>
                              <li><a href="/adminpanel/products"><i class="fa fa-circle-o"></i> All Products</a></li>
                            </ul>
                          </li>
                        ...
                        <li class="treeview">
                          ...
                          <ul class="treeview-menu">
                              <li><a href="/chart"><i class="fa fa-circle-o"></i>User Chart</a></li>
                              <li><a href="/productChart"><i class="fa fa-circle-o"></i> Products Charts</a></li>
                              <li><a href="/productSalesChart"><i class="fa fa-circle-o"></i>products Categories</a></li>
                          </ul>
                        </li>
